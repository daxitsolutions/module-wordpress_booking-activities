...
dataType:"json",success:function(c){if(c.status==="success"){var d=bookacti.selected_template?!1:!0,e=bookacti.booking_system["bookacti-template-calendar"].loading_number;bookacti.selected_template=parseInt(a);bookacti.hidden_activities=[];bookacti.booking_system["bookacti-template-calendar"]=c.booking_system_data;bookacti.booking_system["bookacti-template-calendar"].selected_events=[];bookacti.booking_system["bookacti-template-calendar"].picked_events=[];bookacti.booking_system["bookacti-template-calendar"].loading_number=
e;bookacti.booking_system["bookacti-template-calendar"].method="calendar";bookacti.booking_system["bookacti-template-calendar"].out_of_period_events=!0;bookacti.booking_system["bookacti-template-calendar"].past_events=!0;bookacti.booking_system["bookacti-template-calendar"].past_events_bookable=!0;d&&(bookacti_bind_template_dialogs(),bookacti_init_groups_of_events());bookacti_load_template_calendar();$j("#bookacti-template-activity-list .bookacti-activity").remove();$j("#bookacti-template-activity-list").append(c.activities_list);
bookacti_refresh_activity_list();$j("#bookacti-group-categories").empty();$j("#bookacti-group-categories").append(c.groups_list);$j("#bookacti-template-add-group-of-events-tuto-select-events").toggle(c.groups_list==="");$j("#bookacti-template-groups-of-events-container .dashicons").toggleClass("bookacti-disabled",bookacti.booking_system["bookacti-template-calendar"].loading_number>0);bookacti.booking_system["bookacti-template-calendar"].selected_events=[];$j("#bookacti-insert-group-of-events").css("visibility",
"hidden");$j("#bookacti-template-add-first-group-of-events-container").hide();$j('#bookacti-group-of-events-category-selectbox option[value!="new"]').remove();var g=[];$j("#bookacti-group-categories .bookacti-group-category").each(function(){$j("#bookacti-group-of-events-category-selectbox").append('<option value="'+$j(this).data("group-category-id")+'">'+$j(this).find(".bookacti-group-category-title").attr("title")+"</option>");$j(this).data("visible")==1&&g.push($j(this).data("group-category-id"))});
bookacti_make_group_categories_sortable();bookacti_make_groups_of_events_sortable();bookacti_update_create_form_link_template_id(bookacti.selected_template);bookacti_start_template_loading();bookacti.fc_calendar["bookacti-template-calendar"].gotoDate(moment.utc().locale("en").format("YYYY-MM-DD"));bookacti_clear_events_on_calendar_editor();c=bookacti.fc_calendar["bookacti-template-calendar"].view;c={start:moment.utc(moment.utc(c.currentStart).clone().locale("en").format("YYYY-MM-DD")+" 00:00:00"),
end:moment.utc(moment.utc(c.currentEnd).clone().locale("en").subtract(1,"days").format("YYYY-MM-DD")+" 23:59:59")};c=bookacti_get_interval_of_events($j("#bookacti-template-calendar"),c);$j.isEmptyObject(c)||bookacti_get_calendar_editor_data_by_interval(c);bookacti.load_events=!0;$j("#bookacti-template-calendar").trigger("bookacti_calendar_editor_template_switched");bookacti_stop_template_loading()}else c.status==="failed"&&(d=typeof c.message!=="undefined"?c.message:bookacti_localized.error,alert(d),
console.log(d),console.log(c))},error:function(c){console.log("AJAX "+bookacti_localized.error);console.log(c)},complete:function(){bookacti_stop_template_loading()}})}else $j("#bookacti-template-picker").val(""),bookacti.selected_template=0,$j("#bookacti-first-template-container").show(),$j("#bookacti-template-sidebar, #bookacti-calendar-integration-tuto-container").addClass("bookacti-no-template"),$j("#bookacti-template-calendar").remove(),$j("#bookacti-template-activity-list .bookacti-activity").remove(),
bookacti_display_activity_tuto_if_no_activity_available(),bookacti.booking_system["bookacti-template-calendar"].selected_events=[],$j("#bookacti-insert-group-of-events").css("visibility","hidden"),$j("#bookacti-template-add-first-group-of-events-container").hide(),$j("#bookacti-template-add-group-of-events-tuto-select-events").show(),bookacti_bind_template_dialogs()}
function bookacti_refresh_activity_list(){$j("#bookacti-template-activity-list").css("height",$j("#bookacti-template-activity-list").outerHeight()>200?200:"auto");bookacti_display_activity_tuto_if_no_activity_available();bookacti_refresh_show_hide_activities_icons()}
function bookacti_init_show_hide_activities_switch(){$j("body").on("click","#bookacti-template-activity-list .bookacti-activity-visibility",function(){var a=parseInt($j(this).closest(".bookacti-activity").data("activity-id")),b=$j.inArray(a,bookacti.hidden_activities);$j(this).data("activity-visible")===1?($j(this).removeClass("dashicons-visibility"),$j(this).addClass("dashicons-hidden"),$j(this).data("activity-visible",0),$j(this).attr("data-activity-visible",0),b===-1&&bookacti.hidden_activities.push(a)):
($j(this).addClass("dashicons-visibility"),$j(this).removeClass("dashicons-hidden"),$j(this).data("activity-visible",1),$j(this).attr("data-activity-visible",1),b!==-1&&bookacti.hidden_activities.splice(b,1));typeof bookacti.fc_calendar["bookacti-template-calendar"]!=="undefined"&&bookacti.fc_calendar["bookacti-template-calendar"].render()})}
...
"expand",!0)}
function bookacti_select_events_of_group(a,b){a=a?parseInt(a):0;b=b?b:"";if(!a)return!1;bookacti_unselect_all_events();bookacti.booking_system["bookacti-template-calendar"].selected_events=[];bookacti.fc_calendar["bookacti-template-calendar"].render();var c=[];b&&typeof bookacti.booking_system["bookacti-template-calendar"].groups_events[a]!=="undefined"&&typeof bookacti.booking_system["bookacti-template-calendar"].groups_events[a][b]!=="undefined"&&(c=bookacti.booking_system["bookacti-template-calendar"].groups_events[a][b].slice());c.length||
typeof bookacti.booking_system["bookacti-template-calendar"].groups_data[a]!=="undefined"&&typeof bookacti.booking_system["bookacti-template-calendar"].groups_data[a].events!=="undefined"&&(c=bookacti.booking_system["bookacti-template-calendar"].groups_data[a].events.slice());c.length&&bookacti.fc_calendar["bookacti-template-calendar"].gotoDate(c[0].start);var d=!0;$j.each(c,function(e,g){bookacti_select_event(g)===!1&&(d=!1)});d&&$j('.bookacti-group-of-events[data-group-id="'+a+'"]').addClass("bookacti-selected-group");
return d}
function bookacti_select_event(a){if(typeof a!=="object"||typeof a==="object"&&(typeof a.id==="undefined"||typeof a.start==="undefined"))return!1;var b=typeof a.groupId!=="undefined"?parseInt(a.groupId):parseInt(a.id),c=typeof bookacti.booking_system["bookacti-template-calendar"].events_data[b]!=="undefined"?bookacti.booking_system["bookacti-template-calendar"].events_data[b]:[],d=a.activity_id?a.activity_id:c.activity_id?c.activity_id:0,e="";a.title||(c.title?e=c.title:$j('.bookacti-activity[data-activity-id="'+d+
...
function bookacti_unselect_event(a,b){b=b?!0:!1;if(typeof a!=="object"&&!$j.isNumeric(a)||typeof a==="object"&&(typeof a.id==="undefined"||typeof a.start==="undefined")||$j.isNumeric(a)&&!b)return!1;var c={id:$j.isNumeric(a)?a:typeof a.groupId!=="undefined"?a.groupId:a.id,start:typeof a.start!=="undefined"?moment.utc(a.start).clone().locale("en"):"",end:typeof a.end!=="undefined"?moment.utc(a.end).clone().locale("en"):""};a=c.start?moment.utc(c.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"):
...
group_ids:JSON.stringify(b),nonce:$j("#bookacti-edit-template-nonce").val()},dataType:"json",success:function(c){if(c.status==="success")$j.isEmptyObject(bookacti.booking_system["bookacti-template-calendar"].events)?bookacti.booking_system["bookacti-template-calendar"].events=c.events:bookacti.booking_system["bookacti-template-calendar"].events=bookacti.booking_system["bookacti-template-calendar"].events.concat(c.events),$j.isEmptyObject(bookacti.booking_system["bookacti-template-calendar"].events_data)?
bookacti.booking_system["bookacti-template-calendar"].events_data=c.events_data:$j.extend(bookacti.booking_system["bookacti-template-calendar"].events_data,c.events_data),$j.isEmptyObject(bookacti.booking_system["bookacti-template-calendar"].groups_events)?bookacti.booking_system["bookacti-template-calendar"].groups_events=c.groups_events:$j.extend(!0,bookacti.booking_system["bookacti-template-calendar"].groups_events,c.groups_events),$j.isEmptyObject(bookacti.booking_system["bookacti-template-calendar"].bookings)?
bookacti.booking_system["bookacti-template-calendar"].bookings=c.bookings:$j.extend(!0,bookacti.booking_system["bookacti-template-calendar"].bookings,c.bookings),bookacti_fc_add_events($j("#bookacti-template-calendar"),c.events),$j("#bookacti-template-calendar").trigger("bookacti_calendar_editor_interval_data_loaded",[c,a]);else{var d=typeof c.message!=="undefined"?c.message:bookacti_localized.error;alert(d);console.log(d);console.log(c)}},error:function(c){alert("AJAX "+bookacti_localized.error);
...
function bookacti_clear_events_on_calendar_editor(){bookacti.booking_system["bookacti-template-calendar"].events=[];bookacti.booking_system["bookacti-template-calendar"].events_data=[];bookacti.booking_system["bookacti-template-calendar"].events_interval=[];typeof bookacti.fc_calendar["bookacti-template-calendar"]!=="undefined"&&bookacti.fc_calendar["bookacti-template-calendar"].removeAllEvents()}
function bookacti_update_event_dates(a,b,c,d){c=typeof c!=="undefined"?c:!1;d=typeof d!=="undefined"?d:"";var e="",g={forced_update:0};d==="normal"&&(e="bookacti-update-event-dates-dialog");d==="booked"&&(e="bookacti-update-booked-event-dates-dialog",g=bookacti_serialize_object($j("#bookacti-update-booked-event-dates-form")),g.forced_update=1);e&&$j("#"+e+" .bookacti-notices").remove();var f=typeof a.groupId!=="undefined"?parseInt(a.groupId):parseInt(a.id),n=moment.utc(a.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),
...
[a,b,k,v])}else if(k.status==="failed")if(k.error!=="has_bookings"||g.forced_update){c!==!1&&c();var z=typeof k.message!=="undefined"?k.message:bookacti_localized.error;e?($j("#"+e).append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+z+"</li></ul></div>"),$j("#"+e+" .bookacti-notices").show()):alert(z);console.log(k)}else e&&$j("#"+e).dialog("close"),bookacti_dialog_update_booked_event_dates(a,b,c),$j("#bookacti-update-booked-event-dates-intro").append('<span class="bookacti-bookings-nb">'+
k.bookings_nb+"</span>"),$j("#bookacti-update-booked-event-dates-send_notifications-container").append('<span class="bookacti-notifications-nb">'+k.notifications_nb+"</span>")},error:function(k){c!==!1&&c();alert("AJAX "+bookacti_localized.error);console.log(k)},complete:function(){e&&bookacti_remove_loading_html($j("#"+e));bookacti_stop_template_loading()}})}
function bookacti_duplicate_event(a,b){var c=typeof a.groupId!=="undefined"?parseInt(a.groupId):parseInt(a.id),d=moment.utc(a.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),e=a.end?moment.utc(a.end).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"):d,g=moment.utc(b.start).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"),f=b.end?moment.utc(b.end).clone().locale("en").format("YYYY-MM-DD HH:mm:ss"):g,n={action:"bookactiDuplicateEvent",event_id:c,event_start:d,event_end:e,old_event_start:g,
old_event_end:f,interval:bookacti.booking_system["bookacti-template-calendar"].events_interval,nonce:$j("#bookacti-edit-template-nonce").val()};$j("#bookacti-template-calendar").trigger("bookacti_duplicate_event_before",[a,b,n]);bookacti_start_template_loading();$j.ajax({url:ajaxurl,data:n,type:"POST",dataType:"json",success:function(h){if(h.status==="success")$j.isEmptyObject(h.event_data)||(bookacti.booking_system["bookacti-template-calendar"].events_data[h.event_id]=h.event_data),h.events.length&&
bookacti_fc_add_events($j("#bookacti-template-calendar"),h.events),$j("#bookacti-template-calendar").trigger("bookacti_event_duplicated",[a,b,h,n]);else if(h.status==="failed"){var q=typeof h.message!=="undefined"?h.message:bookacti_localized.error;alert(q);console.log(q);console.log(h)}},error:function(h){alert("AJAX "+bookacti_localized.error);console.log(h)},complete:function(){bookacti_stop_template_loading()}})}
function bookacti_bind_template_dialogs(){bookacti.selected_template?($j("#bookacti-update-template").off().on("click","span",function(){bookacti_dialog_update_template(bookacti.selected_template)}),$j("#bookacti-template-activities-container").off().on("click","#bookacti-insert-activity, #bookacti-template-add-first-activity-button",function(){$j("#bookacti-template-picker option").length>1?bookacti_dialog_choose_activity_creation_type():bookacti_dialog_create_activity()})):($j("#bookacti-update-template").off().on("click",
...
function bookacti_stop_template_loading(a){a=a||!1;bookacti_stop_loading_booking_system($j("#bookacti-template-calendar"),a);bookacti.booking_system["bookacti-template-calendar"].loading_number===0&&($j("#bookacti-template-sidebar .dashicons").removeClass("bookacti-disabled"),$j("#bookacti-template-activities-container .bookacti-activity-draggable").removeClass("bookacti-activity-disabled"),$j(".bookacti-template-dialog").find("input, select, button").attr("disabled",!1),$j("#bookacti-template-picker").attr("disabled",
!1))}function bookacti_display_activity_tuto_if_no_activity_available(){$j("#bookacti-template-first-activity-container").length&&$j("#bookacti-template-first-activity-container").toggle($j(".bookacti-activity").length<=0);$j("#bookacti-template-no-activity").length&&$j("#bookacti-template-no-activity").toggle($j(".bookacti-activity").length<=0)}
function bookacti_maybe_display_add_group_of_events_button(){$j("#bookacti-template-add-first-group-of-events-container").length&&(bookacti.booking_system["bookacti-template-calendar"].selected_events.length>=2?($j("#bookacti-insert-group-of-events").css("visibility","visible"),$j(".bookacti-group-category").length||($j("#bookacti-template-add-group-of-events-tuto-select-events").hide(),$j("#bookacti-template-add-first-group-of-events-container").show())):($j("#bookacti-template-add-first-group-of-events-container").hide(),
...
function bookacti_expand_collapse_groups_of_events(a,b,c){c=c?!0:!1;b=$j.inArray(b,["expand","collapse"])>=0?b:!1;var d=$j('.bookacti-group-category[data-group-category-id="'+a+'"]').data("show-groups");!d&&b!=="collapse"||b==="expand"?d&&b!=="expand"||b==="collapse"||(c&&bookacti_expand_collapse_all_groups_of_events("collapse",a),$j('.bookacti-group-category[data-group-category-id="'+a+'"]').attr("data-show-groups",1),$j('.bookacti-group-category[data-group-category-id="'+a+'"]').data("show-groups",
...
function bookacti_expand_collapse_all_groups_of_events(a,b){b=$j.isArray(b)?b:$j.isNumeric(b)?[b]:[];var c=".bookacti-group-category";$j.each(b,function(d,e){c+=':not([data-group-category-id="'+e+'"])'});a==="collapse"?($j(c).attr("data-show-groups",0),$j(c).data("show-groups",0),$j(c+" .bookacti-groups-of-events-editor-list").slideUp(200)):a==="expand"&&($j(c).attr("data-show-groups",1),$j(c).data("show-groups",1),$j(c+" .bookacti-groups-of-events-editor-list").slideDown(200))}
function bookacti_load_activities_bound_to_template(a){parseInt(a)!==parseInt(bookacti.selected_template)&&($j("#bookacti-activity-import-dialog .bookacti-notices").remove(),bookacti_start_template_loading(),bookacti_add_loading_html($j("#bookacti-activity-import-dialog")),$j.ajax({url:ajaxurl,data:{action:"bookactiGetActivitiesByTemplate",selected_template_id:a,current_template_id:bookacti.selected_template,nonce:$j("#bookacti-edit-template-nonce").val()},type:"POST",dataType:"json",success:function(b){$j("select#bookacti-activities-to-import option").remove();
if(b.status==="success")b.activities&&$j.each(b.activities,function(d,e){$j('#bookacti-template-activity-list .bookacti-activity[data-activity-id="'+d+'"]').length||$j("select#bookacti-activities-to-import").append('<option value="'+d+'" >'+e.title+"</option>")});else{var c=typeof b.message!=="undefined"?b.message:bookacti_localized.error;$j("#bookacti-activity-import-dialog").append('<div class="bookacti-notices"><ul class="bookacti-error-list"><li>'+c+"</li></ul></div>");$j("#bookacti-activity-import-dialog .bookacti-notices").show();
